package com.nanored.vpn.service
...
import com.nanored.vpn.contracts.ServiceControl
import com.nanored.vpn.contracts.Tun2SocksControl
import com.nanored.vpn.handler.MmkvManager
import com.nanored.vpn.handler.NotificationManager
...
import com.nanored.vpn.util.MyContextWrapper
...
//    }
    ...
    override fun startService() {
        try {
            ...
            Log.e(AppConfig.TAG, "VPN interface not initialized", e)
            MessageUtil.sendMsg2UI(this, AppConfig.MSG_STATE_START_FAILURE, "")
            return
        }
    ...
    private fun runTun2socks() {
        if (SettingsManager.isUsingHevTun() && TProxyService.isAvailable) {
