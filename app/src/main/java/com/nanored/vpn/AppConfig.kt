...
object AppConfig {
    ...
    const val PREF_ROUTING_VERSION = "pref_routing_version"
    const val ROUTING_VERSION = 1
    ...
    const val CACHE_SELECTED_COUNTRY = "cache_selected_country"
    ...
    const val APP_URL = "https://t.me/nanored_ru_bot"
    const val APP_API_URL = "https://nanored.top/update.txt"
    const val APP_ISSUES_URL = "https://t.me/nanored_support_bot"
    const val APP_WIKI_MODE = ""
    const val APP_PRIVACY_POLICY = ""
    const val APP_PROMOTION_URL = ""
    const val TG_CHANNEL_URL = "https://t.me/nanored_ru_bot"
...
//    const val IP_API_URL = "https://speed.cloudflare.com/meta"
    ...
    const val DNS_PROXY = "https://dns1.nanored.top/dns-query,https://dns2.nanored.top/dns-query"
    const val DNS_DIRECT = "https://dns1.nanored.top/dns-query,https://dns2.nanored.top/dns-query"
    const val DNS_VPN = "1.1.1.1,8.8.8.8"
    ...
    const val RAY_NG_CHANNEL_ID = "NANORED_VPN_CH_ID"
    const val RAY_NG_CHANNEL_NAME = "NanoredVPN Background Service"
    const val SUBSCRIPTION_UPDATE_CHANNEL = "subscription_update_channel"
    const val SUBSCRIPTION_UPDATE_CHANNEL_NAME = "NanoredVPN Subscription Update"
