...
import com.nanored.vpn.dto.IPAPIInfo
...
object SpeedtestManager {
    ...
    fun getRemoteIPInfo(): String? {
        ...
        val flag = if (!countryCode.isNullOrBlank()) {
            com.nanored.vpn.util.CountryUtils.getCountryFlag(countryCode)
        } else ""

        return "${flag}(${countryCode ?: "?"}) ${ip ?: "unknown"}"
    }
}
