...
import com.nanored.vpn.AppConfig.GEOIP_PRIVATE
import com.nanored.vpn.AppConfig.GEOSITE_PRIVATE
import com.nanored.vpn.AppConfig.TAG_DIRECT
import com.nanored.vpn.AppConfig.VPN
import com.nanored.vpn.enums.EConfigType
import com.nanored.vpn.enums.Language
import com.nanored.vpn.dto.ProfileItem
import com.nanored.vpn.enums.RoutingType
import com.nanored.vpn.dto.RulesetItem
import com.nanored.vpn.dto.ServersCache
import com.nanored.vpn.dto.V2rayConfig
import com.nanored.vpn.enums.VpnInterfaceAddressConfig
import com.nanored.vpn.handler.MmkvManager.decodeServerConfig
import com.nanored.vpn.handler.MmkvManager.decodeServerList
...
object SettingsManager {
    ...
    fun initRoutingRulesets(context: Context) {
        val savedVersion = MmkvManager.decodeSettingsInt(AppConfig.PREF_ROUTING_VERSION, 0)
        val exist = MmkvManager.decodeRoutingRulesets()
        if (exist.isNullOrEmpty() || savedVersion < AppConfig.ROUTING_VERSION) {
            val rulesetList = getPresetRoutingRulesets(context)
            MmkvManager.encodeRoutingRulesets(rulesetList)
            MmkvManager.encodeSettings(AppConfig.PREF_ROUTING_VERSION, AppConfig.ROUTING_VERSION)
        }
    }
    ...
    fun ensureDefaultSettings() {
        ...
        // Force disable HevTun — native library not bundled
